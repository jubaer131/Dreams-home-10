...
const AboutUs = () => {
    return (
        <div>
            ...
            <div className=" ">
                <section className="py-6 sm:py-12 dark:bg-green-100 dark:text-gray-800 container  mx-auto">
                    <div className="container  mx-auto space-y-8">
                        <div className="space-y-2 text-center">
                            <h2 className="text-4xl font-bold">About Us</h2>
                            <p className="font-serif text-[16px] dark:text-gray-600">We are on a mission to make building better UIS effortless .</p>
                            <p>Together, we are enabling developer & designers to bring stunning UIS to life with unrivalled spreed and ease</p>
                        </div>
                        <div className="grid grid-cols-1  gap-x-2  gap-y-8 md:grid-cols-2 lg:grid-cols-4">
                            <article className="flex flex-col dark:bg-gray-50">
                                <div className=" md:w-full p-6 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900">
                                    <img src="https://i.ibb.co/ZfPDR7h/worker-standing-his-three-coworkers-construction-site.jpg" alt="" className=" animate__animated animate__bounce object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
                            ...
                            <article className="flex flex-col dark:bg-gray-50">
                                <div className="md:w-full p-6 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900">
                                    <img src="https://i.ibb.co/1GnSTTz/elegant-businessmen-paying-attention.jpg" alt="" className=" animate__animated animate__flip object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
                            ...
                            <article className="flex flex-col dark:bg-gray-50">
                                <div className="md:w-full p-6 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900">
                                    <img src="https://i.ibb.co/ZYC9PXk/engineer-two-workers-communicating-construction-site.jpg" alt="" className=" animate__animated animate__flip object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
                            ...
                            <article className="flex flex-col dark:bg-gray-50">
                                <div className="md:w-full p-6 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900">
                                    <img src="https://i.ibb.co/LC5RPX1/low-angle-male-coworkers-meeting-office.jpg" alt="" className=" animate__animated animate__flip object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
                ...
                <section className="p-6 dark:bg-gray-100 dark:text-gray-800 container  mx-auto shadow-inner mt-5">
                    <div className="container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-4xl">2014</p>
                            <p className="text-sm sm:text-base text-teal-500 ">Starting year</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-4xl">89K</p>
                            <p className="text-sm sm:text-base text-teal-500 ">Followers on social media</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-4xl">100%</p>
                            <p className="text-sm sm:text-base text-teal-500 ">Global team</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-4xl">20+</p>
                            <p className="text-sm sm:text-base text-teal-500 ">Countris represented</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-4xl">10</p>
                            <p className="text-sm sm:text-base text-teal-500 ">Years of experience</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-4xl">10+</p>
                            <p className="text-sm sm:text-base text-teal-500 ">Workshops</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="dark:bg-gray-100 dark:text-gray-800 container p-6 mx-auto shadow-inner mt-5">
                    <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
                        ...
                        <div className="grid gap-10 md:gap-8 sm:p-3 md:grid-cols-2 lg:px-12 xl:px-32">
                            <div>
                                <h3 className="font-semibold text-xl mb-3 text-teal-600 ">Property Management:</h3>
                                <ul>
                                    <li className="list-disc">How do I find a reliable property management company?</li>
                                    <li className="list-disc">What services does a property management company offer?</li>
                                    <li className="list-disc">How can I maximize the rental income from my property?</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="font-semibold text-xl mb-3 text-teal-600">Investment Properties:</h3>
                                <ul>
                                    <li className="list-disc">What are the benefits of investing in real estate?</li>
                                    <li className="list-disc">How do I evaluate potential investment properties?</li>
                                    <li className="list-disc">What are some key trends in the real estate market that investors should be aware of?</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="font-semibold text-xl mb-3 text-teal-600">Real Estate Agent Services:</h3>
                                <ul>
                                    <li className="list-disc">How do I choose the right real estate agent to represent me?</li>
                                    <li className="list-disc">What services does a real estate agent provide?</li>
                                    <li className="list-disc">What are the benefits of working with a real estate agent when buying or selling property?</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="font-semibold text-xl mb-3 text-teal-600">Buying and Selling Property:</h3>
                                <ul>
                                    <li className="list-disc">How do I buy a house?</li>
                                    <li className="list-disc">What are the steps involved in selling my property?</li>
                                    <li className="list-disc">What factors influence property prices in a certain area?</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-6 dark:bg-gray-100 dark:text-gray-800 container p-6 mx-auto shadow-inner mt-5">
                    <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
                        <h1 className="text-4xl font-bold leading-none text-center sm:text-4xl">Our team</h1>
                        ...
                        <div className="flex flex-row flex-wrap-reverse justify-center">
                            <div className="flex flex-col justify-center m-8 text-center">
                                <img alt="" className="animate__animated animate__fadeInBottomLeft self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/v4gCCsD/christian-buehner-DIt-Ylc26z-VI-unsplash.jpg" />
                                <p className="text-xl font-semibold leading-tight">Leroy Jenkins</p>
                                <p className="dark:text-gray-600">Structural Engineers</p>
                            </div>
                            <div className="flex flex-col justify-center m-8 text-center">
                                <img alt="" className="animate__animated animate__fadeInBottomLeft self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/vZZnWRL/jack-finnigan-rri-AI0nhcbc-unsplash.jpg" />
                                <p className="text-xl font-semibold leading-tight">khalil uddin</p>
                                <p className="dark:text-gray-600">Civil Engineers</p>
                            </div>
                            <div className="flex flex-col justify-center m-8 text-center">
                                <img alt="" className=" animate__animated animate__fadeInBottomLeft self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/pxVW8g2/pexels-karolina-grabowska-6333501.jpg" />
                                <p className="text-xl font-semibold leading-tight">William</p>
                                <p className="dark:text-gray-600">Mechanical Engineers</p>
                            </div>
                            <div className="flex flex-col justify-center m-8 text-center">
                                <img alt="" className="animate__animated animate__fadeInBottomLeft self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/2nZYTyk/pexels-alex-green-5699844.jpg" />
                                <p className="text-xl font-semibold leading-tight">Samuel</p>
                                <p className="dark:text-gray-600">Construction Managers</p>
                            </div>
                            <div className="flex flex-col justify-center m-8 text-center">
                                <img alt="" className="animate__animated animate__fadeInBottomRight self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/7Kh5rb1/pexels-samad-ismayilov-1270076.jpg" />
                                <p className="text-xl font-semibold leading-tight">James</p>
                                <p className="dark:text-gray-600">Environmental Engineers</p>
                            </div>
                            <div className="flex flex-col justify-center m-8 text-center">
                                <img alt="" className="animate__animated animate__fadeInBottomRight self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/3kYMyJL/author.jpg" />
                                <p className="text-xl font-semibold leading-tight">Alexander</p>
                                <p className="dark:text-gray-600">Interior Designers</p>
                            </div>
                        </div>
                    </div>
                </section>
                <section className="p-6 dark:bg-gray-100 dark:text-gray-800 container  mx-auto shadow-inner mt-5">
                    ...
                    <div className="container flex flex-wrap justify-center mx-auto dark:text-gray-600 ">
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-orange-500">
                        ...
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-[#b80b6a]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
                        ...
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-purple-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
                        ...
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
                        ...
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-[#b58787]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
                        ...
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-green-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
                        ...
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 text-red-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
