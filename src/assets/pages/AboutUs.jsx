                ...
                <section className="py-6 sm:py-12 dark:bg-green-100 dark:text-gray-800 container  mx-auto">
                    <div className="container  mx-auto space-y-8">
                        <div className="space-y-2 text-center">
                            ...
                            <p className="font-serif text-sm dark:text-gray-600">We are on a mission to make building better UIS effortless .</p>
                ...
                <section className="p-6 dark:bg-gray-100 dark:text-gray-800 container  mx-auto shadow-inner mt-5">
                    <div className="container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-3">
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-6xl">2014</p>
                            <p className="text-sm sm:text-base">Starting year</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                        ...
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            ...
                            <p className="text-sm sm:text-base">Global team</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                            <p className="text-4xl font-bold leading-none lg:text-6xl">20+</p>
                            <p className="text-sm sm:text-base">Countris represented</p>
                        </div>
                        <div className="flex flex-col justify-start m-2 lg:m-6">
                ...
                <section className="dark:bg-gray-100 dark:text-gray-800 container p-6 mx-auto shadow-inner mt-5">
                    <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
                        ...
                        <div className="grid gap-10 md:gap-8 sm:p-3 md:grid-cols-2 lg:px-12 xl:px-32">
                            ...
                            <div>
                                <h3 className="font-semibold">Real Estate Agent Services:</h3>
                                <ul>
                            ...
                            <div>
                                <h3 className="font-semibold">Buying and Selling Property:</h3>
                                <ul>
